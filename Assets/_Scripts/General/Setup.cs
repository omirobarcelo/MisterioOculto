...
namespace Shoguneko
{
    ...
    public class Setup : MonoBehaviour
    {
        ...
        void OnLoadedLevel(Scene scene, LoadSceneMode mode)
        {
            ...
            if (player.characterEntity.activeSelf)
            {
                // Set the UI Active.
        ...
        public void StopPlayer()
        {
            ...
            player.CharacterAnimator.Play("Idle");
        }
        ...
        {
            // Only completely unfreese if inventory is not active
            // else, the player will be able to move while the inventory is active
            // The inventory will activate player movement and interaction
